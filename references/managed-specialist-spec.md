...
- be generated from sanitized safe inputs rather than copying arbitrary repo prose into role rules
...
- require matching managed marker, project slug, role id, template id, and source-of-truth path
...
- prefer archive or preview before destructive removal when practical
